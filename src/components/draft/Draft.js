...
class Draft extends React.Component {
  ...
  render() {
    ...
    const row = convertToRaw(state)

    const handleSubmit = async () => {
      const outpatientId = this.props.outpatientId
    ...
    return (
      <>
        <div className='RichEditor-root'>
          ...
          <div className={className} onClick={this.focus}>
            <Editor
              ...
              placeholder={this.props.readOnly ? '' : 'Write a comment...'}
              ref='editor'
              spellCheck={true}
        ...
        {!this.props.readOnly && (
          <button onClick={handleSubmit} className='draftsButton'>
            Submit
          </button>
        )}
      </>
